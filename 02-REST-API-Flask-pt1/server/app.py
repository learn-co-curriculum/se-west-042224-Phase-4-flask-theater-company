...
class Productions(Resource):
    ...
    def get(self):
        ...
        prods_list = [production.to_dict() for production in Production.query.all()]
    ...
    # Prepare a POST request in Postman. Under the `Body` tab, select `json and fill out the body
